...
1. ✅ **Day 6-1교시**: 환경 구축 50분 전체 확보
2. ✅ **Day 6-2교시**: JSON + with문 (텍스트 파일 제외, JSON 집중)
3. ✅ with문과 JSON을 실전에서 배움
4. ✅ 파일 입출력은 JSON에만 집중 (FastAPI 실무 중심)
5. ✅ 실습 시간 확보 및 트러블슈팅 대비
