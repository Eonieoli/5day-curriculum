...
> **참고**: remove(), pop()은 Day 2-3교시에서 다룸!
...
> **중요 변경**: 튜플과 집합을 한 교시에! FastAPI에서 덜 중요한 자료형이므로
...
### 7교시: for문 심화 + 리스트 컴프리헨션 맛보기 ⭐⭐

- **for문 심화 (40분)**:
  - **개념 (5분)**: 중첩 for문, enumerate 활용
  - **Basic (15분)**:
    - 중첩 for문
    - break/continue 활용
    - enumerate() 심화
...
- **리스트 컴프리헨션 맛보기 (10분)** ⭐:
  ...
  - **Basic (5분)**:
    ...
    ```
  - **Practice (2분)**: 간단한 예제 따라하기

> **중요**: 깊게 들어가지 말고 "이런 게 있다" 정도만!
> 실무에서 자주 쓰이므로 맛보기는 필수!

### 8교시: Day 3 종합 실습

- **복습 퀴즈 (10분)**: 딕셔너리, 제어문, Truthy/Falsy
- **🟢 기초 Problem (15분)**: 메뉴 선택 (while + 딕셔너리)
- **🟡 응용 Problem (15분)**: 성적 처리 (for + 딕셔너리)
- **🔴 도전 Problem (10분)**: 간단한 게임
...
- **🟡 응용 Problem (15분)**: 데이터 검증 시스템 (\*\*kwargs 활용)
...
1. ✅ **Day 2-5교시**: 튜플 + 집합 통합 (각 25분)
2. ✅ **Day 2-6교시**: 딕셔너리 기초 50분 확보
3. ✅ **Day 3-7교시**: 리스트 컴프리헨션 맛보기 추가 (10분)
4. ✅ **Day 5-3교시**: 클래스 상속 기초 (super() 제외)
5. ✅ FastAPI 중심 설계 강화
6. ✅ 실무 준비도 향상
